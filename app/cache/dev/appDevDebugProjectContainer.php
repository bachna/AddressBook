...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'contacts', 'user' => 'root', 'password' => 'coderslab', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/ContactsBundle/Entity'))), 'ContactsBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ContactsBundle' => 'ContactsBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ebd1ba3923c95ed2454ccf24132041ccd6de60e867ef6e0dcc5a2f90597d4121');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/ContactsBundle/Resources/views'), 'Contacts');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4dacf38e0a1a4c05fe1b5c22326eb2fb2a1046d0');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59785e926bbda9.72768899')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ContactsBundle' => 'ContactsBundle\\ContactsBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'ContactsBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ContactsBundle'),
            ...
            'secret' => '4dacf38e0a1a4c05fe1b5c22326eb2fb2a1046d0',
            'locale' => 'en',
            ...
            'kernel.secret' => '4dacf38e0a1a4c05fe1b5c22326eb2fb2a1046d0',
